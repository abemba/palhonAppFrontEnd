palhonApp.controller("availability",function($scope)
{
    ...
    $scope.updateWeekAvailability = function(timeSwitch)
    {
        console.log(button);
        var button = timeSwitch.target;
        var timeText = button.parentNode.parentNode.previousElementSibling
        if(button.className == "on"){ button.className ="off"; button.innerHTML="OFF";timeText.className="textCross"}else{button.className ="on";button.innerHTML="ON";timeText.className=""}
    }
